...
[ -z "$DRBD_TESTS_SUB_DIR" ] && die "Missing \$DRBD_TESTS_SUB_DIR"
...
ci_tests_config="$(virter/vmshed_tests_generator.py --tests-dir "$DRBD_TESTS_SUB_DIR" --selection ci --drbd-version "$DRBD_VERSION")"
